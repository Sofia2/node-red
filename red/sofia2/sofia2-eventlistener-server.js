...
function filterNodeSSAP(node, body) {
    ...
    if ((node != null && node != undefined) && (body != null && body != undefined)) {
        ...
        var nodeType = node.config.type;
        var nodeDirection = node.config.direccion;
        var nodeTypeMsg = node.config.tipomensaje;
        var nodeOntology = node.config.ontology;
        var nodeKP = node.config.kp;
        var nodeInstanceKP = node.config.instanciakp;
        ...
        var bodyKP = body.kp;
        var bodyInstanceKP = body.instanceKp;
		...
		if(nodeTypeMsg!=null && nodeTypeMsg!=undefined && nodeTypeMsg.toString().toUpperCase()!='ALL' && bodyTypeMsg!=null && bodyTypeMsg!=undefined){
		...
		if(nodeOntology!=null && nodeOntology!=undefined && nodeOntology.toString().toUpperCase()!='' && bodyOntology!=null && bodyOntology!=undefined){
		...
		if(nodeKP!=null && nodeKP!=undefined && nodeKP.toString().toUpperCase()!='' && bodyKP!=null && bodyKP != undefined){
		...
		if(nodeInstanceKP !=null && nodeInstanceKP!=undefined && nodeInstanceKP.toString().toUpperCase()!='' && bodyInstanceKP!=null && bodyInstanceKP!=undefined){
...
function filterNodeRules(node, body) {
    ...
    if ((node != null && node != undefined) && (body != null && body != undefined)) {
		...
		if(nodeType!=null && nodeType !=undefined && bodyType!=null && bodyType!=undefined){
  ...
  for (i in listeners){
    ...
    if(node!=null && node !=undefined && node.type ==typeNodeSSAP){
         ...
         if(filterNodeSSAP(node,body)){
            node.emit('notifySofia2Event',body.message);
         }
